...
public class F_M_Right : MonoBehaviour
{
    ...
    private int direction = 1; // Hareket yönü (1 ileri, -1 geri)
    ...
    private void FloorMoveRight()
    {
        ...
        transform.position += Vector3.forward * direction * moveAmount;
